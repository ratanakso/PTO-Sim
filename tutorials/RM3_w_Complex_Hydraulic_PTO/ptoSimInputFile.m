...
valve.Cd = ptosim.valve.Cd;
valve.Amax = ptosim.valve.Amax;
valve.Amin = ptosim.valve.Amin;
valve.pMax = ptosim.valve.pMax;
valve.pMin = ptosim.valve.pMin;
valve.rho = ptosim.valve.rho;
valve.k1 = ptosim.valve.k1;
valve.k2 = ptosim.valve.k2;
