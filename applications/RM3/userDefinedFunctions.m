...
option = menu('Please select your PTO-Sim.','Simple Hydraulic','Complex Hydraulic','Direct Drive');
...
if option == 1
    ...
    clear pto tot motor.bf piston valve highAccum lowAccum motor gen logsout f
end
...
if option == 2
    ...
    clear pto tot motor.bf piston highAccum lowAccum motor gen logsout f
end

%% Direct Drive
if option == 3
    
    ptoSim.variables.machine = machine;
    ptoSim.variables.load = ddload;
    ...
    clear pto machine ddload logsout f
end
