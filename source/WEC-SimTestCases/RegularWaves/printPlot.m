...
subplot(2,3,4)
m=plot(   regular.B1.WEC_Sim_org.time(find(    regular.B1.WEC_Sim_org.time==startTime):end),...
          regular.B1.WEC_Sim_org.heave(find(   regular.B1.WEC_Sim_org.time==startTime):end),'k-',...
...
subplot(2,3,5)
m=plot(   regular.B2.WEC_Sim_org.time(find(    regular.B2.WEC_Sim_org.time==startTime):end),...
          regular.B2.WEC_Sim_org.heave(find(   regular.B2.WEC_Sim_org.time==startTime):end),'k-',...
...
subplot(2,3,6)
m=plot(   regular.Rel.WEC_Sim_org.time(find(    regular.Rel.WEC_Sim_org.time==startTime):end),...
          regular.Rel.WEC_Sim_org.heave(find(   regular.Rel.WEC_Sim_org.time==startTime):end),'k-',...
